...
--
-- Host: localhost    Database: assettrend_track
-- ------------------------------------------------------
...
SET @@GLOBAL.GTID_PURGED=/*!80000 '+'*/ '7997ab12-9a7d-11f1-897d-ec3a5631f919:1-150';
...
CREATE TABLE `model_predictions` (
  ...
  `predicted_close` decimal(18,8) NOT NULL,
  `confidence_score` decimal(5,4) DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  KEY `idx_target_time` (`asset_id`,`target_timestamp`),
  CONSTRAINT `model_predictions_ibfk_1` FOREIGN KEY (`asset_id`) REFERENCES `assets` (`id`) ON DELETE CASCADE
...
-- Dump completed on 2026-09-04 17:33:34
